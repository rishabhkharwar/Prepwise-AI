...
const Home = () => {
    ...
    const { loading, error, clearError, generateReport, reports, getReports } = useInterview()
                            ...
                            <label className={`dropzone ${resumeFileName ? 'dropzone--selected' : ''}`} htmlFor='resume'>
                                {resumeFileName ? (
                                    <>
                                        ...
                                        <p className='dropzone__title dropzone__title--success'>{resumeFileName}</p>
                                        <p className='dropzone__subtitle'>Click to change file</p>
                                        <button type='button' className='dropzone__clear' onClick={handleClearFile}>✕ Remove</button>
                                    </>
                                ) : (
                                    <>
